...
namespace PlayerAndEditorGUI {
    ...
    public static class pegi {
        ...
        private static bool enter_Search_HeaderPart<T>(this ListMetaData meta, ref List<T> list, ref int enteredOne, int thisOne, bool showLabelIfTrue = false) {
