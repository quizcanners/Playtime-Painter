...
#pragma warning disable IDE0019 // Use pattern matching
    [ExecuteInEditMode]
    public class PlaytimePainter_DepthProjectorCamera : PainterSystemMono {

        public enum Mode { Clear, ReplacementShader }
        
        public static PlaytimePainter_DepthProjectorCamera Instance {
            get  {
                ...
                if (!triedToFindDepthCamera)
                {
                    ...
                    PainterCamera.depthProjectorCamera = FindObjectOfType<PlaytimePainter_DepthProjectorCamera>();
                }
       ...
       public override void Inspect()
        {
            ...
            if (PlaytimePainter_RenderTextureBuffersManager.InspectDepthTarget().nl())
                UpdateDepthCamera();
        ...
        private void OnEnable() {
            ...
            PlaytimePainter_RenderTextureBuffersManager.UpdateDepthTarget();
            UpdateDepthCamera();

            PainterCamera.depthProjectorCamera = this;

            _painterDepthTexture.GlobalValue = PlaytimePainter_RenderTextureBuffersManager.depthTarget;
        ...
        private void RequestRender(bool updatePainterIfNoUser) {
            ...
            if (userToGetUpdate == null) { 
                ...
                _projectorCamera.targetTexture = PlaytimePainter_RenderTextureBuffersManager.depthTarget;
        ...
        private readonly QcUnity.ChillLogger logger = new QcUnity.ChillLogger();
    ...
    public interface IUseDepthProjector {
        ...
        PlaytimePainter_DepthProjectorCamera.Mode GetMode();
    }
    ...
    [PEGI_Inspector_Override(typeof(PlaytimePainter_DepthProjectorCamera))] internal class DepthProjectorCameraDrawer : PEGI_Inspector_Override { }
