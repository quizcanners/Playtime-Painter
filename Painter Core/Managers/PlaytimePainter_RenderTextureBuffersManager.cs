...
#pragma warning disable IDE0018 // Inline variable declaration
    ...
    public static class PlaytimePainter_RenderTextureBuffersManager {
        ...
        private static readonly QcUnity.ChillLogger logger = new QcUnity.ChillLogger("error");
    ...
    public static class TextureEditorExtensionFunctions
    {
        ...
        public static float StrokeWidth(this Brush br, float pixWidth, bool world) => br.Size(world) / (pixWidth) * 2 * PainterCamera.OrthographicSize;

        public static bool IsSingleBufferBrush(this Brush b) => (PainterCamera.Inst.IsLinearColorSpace && b.GetBlitMode(false).SupportedBySingleBuffer && b.GetBrushType(false).SupportedBySingleBuffer && b.PaintingRGB);
        ...
        public static bool IsBigRenderTexturePair(this Texture tex) => tex && (tex == PlaytimePainter_RenderTextureBuffersManager.GetPaintingBufferIfExist(0));
