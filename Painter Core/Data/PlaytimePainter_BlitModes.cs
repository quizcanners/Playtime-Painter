    ...
    public static class BlitModes {
        ...
        public class Projector : Base
        {
            ...
            protected override bool Inspect()
            {
                ...
                var depthCamera = PlaytimePainter_DepthProjectorCamera.Instance;
                ...
                if (!depthCamera)
                {
                    ...
                    {
                        QcUnity.Instantiate<PlaytimePainter_DepthProjectorCamera>();
                    }
                }
                else
                {
...
#region Custom
        ...
        public class Custom : Base
        {
            ...
            protected override bool Inspect()
            {
                ...
                if (CustomCfg)
                {
                    if (CustomCfg.name.isFoldout(ref _showConfig).nl())
                    {
                ...
                if ("Grahics BLIT".Click().nl())
                    PlaytimePainter_RenderTextureBuffersManager.Blit(
