...
namespace PlaytimePainter
{
    public static class PaintCommand 
    {
        public class UV
        {
            ...
            internal UV(Stroke stroke, TextureMeta textureData, Brush brush)
            {
                Stroke = stroke;
        ...
        public abstract class WorldSpaceBase : UV
        {
            ...
            internal WorldSpaceBase(Stroke stroke, TextureMeta textureData, Brush brush): base(stroke, textureData, brush) { }
        }
        ...
        public class WorldSpace : WorldSpaceBase
        {
            ...
            internal WorldSpace(Stroke stroke, TextureMeta textureData, Brush brush, SkinnedMeshRenderer skinnedMeshRenderer, int subMeshIndexFirst, GameObject gameObject) : base(stroke, textureData, brush)
            {
