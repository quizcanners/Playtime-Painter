...
#pragma warning disable IDE0018 // Inline variable declaration
    ...
    public static class BlitFunctions {
        ...
        internal static void PrepareCpuBlit(this Brush bc, TextureMeta id)
        {
            half = (bc.Size(false)) / 2;

            var smooth = bc.GetBrushType(TexTarget.Texture2D) != BrushTypes.Pixel.Inst;
            ...
            blitMode = bc.GetBlitMode(TexTarget.Texture2D).BlitFunctionTex2D(id);
