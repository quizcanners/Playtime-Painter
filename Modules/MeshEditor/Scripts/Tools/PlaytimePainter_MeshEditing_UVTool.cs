...
namespace PlaytimePainter.MeshEditing
{
    public class VertexUVTool : MeshToolBase, IMeshToolWithPerMeshData
    {
        ...
        #region Inspect
        public override string GetNameForInspector()=> "vertex UV";
       ...
       public override void Inspect() {
            ...
            if ("Processors".isFoldout(ref meshProcessors).nl())  {
                ...
                if (projectionUv) {
                    ...
                    if ("Auto - Project All sides".ClickConfirm(confirmationTag: "Auto Project", toolTip: "This will change UV of the entire mesh").nl())
                    {
                        ...
                        {
                            PlaytimePainter_GridNavigator.Instance.CurrentPlane = (GridPlane)plane;
                            projectFront = true;
        ...
        public Vector2 PosToUv(Vector3 diff)
        {
            ...
            switch (PlaytimePainter_GridNavigator.Instance.CurrentPlane)
            {
                case GridPlane.xy:
                    uv.x = diff.x;
                    uv.y = diff.y;
        ...
        */
        ...
        private void AutoProjectUVs(PP_MeshData eMesh) {
            ...
            var gn = PlaytimePainter_GridNavigator.Instance;
