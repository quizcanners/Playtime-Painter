...
namespace PlaytimePainter.MeshEditing
{
    ...
    public class VertexColorTool : MeshToolBase
    {
        ...
        public override void Inspect()
        {
            ...
            "Mode".editEnum(ref _detectionMode).nl();

            "Make Vertex Unique On Paint".toggleIcon(ref Cfg.makeVerticesUniqueOnEdgeColoring).nl();


            "Paint Radius".toggleIcon(ref _isPaintingWithRadius, hideTextWhenTrue: true);
            if (_isPaintingWithRadius)
                "Radius".edit(60, ref _radiusOfPainting, min: em.averageSize * 0.001f, max: em.averageSize);

            pegi.nl();

            "Flow".edit01(50, ref _alpha).nl();
