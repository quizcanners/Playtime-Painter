...
namespace PlaytimePainter.Modules
{
    ...
    public class PP_SceneLighting_Configurations : ConfigurationsSO_Generic<WeatherConfig>, IPEGI
    {
    ...
    public class WeatherConfig : Configuration
    {
        ...
        public override Configuration ActiveConfiguration
        {
            ...
            {
                activeConfig = value;
                PP_SceneLightingManager.inspected.Decode(value.data);
            }
        }

        public override CfgEncoder EncodeData() => PP_SceneLightingManager.inspected.Encode();
