    ...
    namespace CameraModules
    {
            ...
            IUseDepthProjector, IUseReplacementCamera
        {
            ...
            public bool PaintRenderTextureInternal(PaintCommand.UV cfg)
            {
                ...
                PlaytimePainter_RenderTextureBuffersManager.Blit(null, image.CurrentRenderTexture(),
            ...
            public void AfterCameraRender(RenderTexture texture)
            {
                ...
                var size = PlaytimePainter_RenderTextureBuffersManager.tinyTextureSize;

                int pixelsCount = size * size;

                var tiny = PlaytimePainter_RenderTextureBuffersManager.GetDownscaleOf(texture,
                    PlaytimePainter_RenderTextureBuffersManager.tinyTextureSize, true);

                var pix = PlaytimePainter_RenderTextureBuffersManager.GetMinSizeTexture().CopyFrom(tiny).GetPixels();
            ...
            public RenderTexture GetTargetTexture() => PlaytimePainter_RenderTextureBuffersManager.GetRenderTextureWithDepth();

            public PlaytimePainter_DepthProjectorCamera.Mode GetMode() => PlaytimePainter_DepthProjectorCamera.Mode.ReplacementShader;
