...
namespace StoryTriggerData
{
    ...
    public static class EXAMPLE_PlayerStats_Extensions
    {
        ...
        public static int Get(this STD_Values st, Example_PlayerStats.integers ind) {
            return st.ints[Example_PlayerStats.group][(int)ind];
        }

        public static void Set(this STD_Values st, Example_PlayerStats.integers ind, int value) {
            st.ints[Example_PlayerStats.group][(int)ind] = value;
        }

        public static bool Get(this STD_Values st, Example_PlayerStats.booleans ind) {
            return st.bools[Example_PlayerStats.group][(int)ind];
        }

        public static void Set(this STD_Values st, Example_PlayerStats.booleans ind, bool value) {
